...
public class BruteForce {
    ...
    public static Set<NewNode> settledNodes = new HashSet<>();
    public static Set<NewNode> unsettledNodes = new HashSet<>();
        public static Graph calculateBrute(Graph graph, NewNode source, NewNode goal) {
            ...
            while (currentNode != goal) {
                currentNode = getShortestDistanceNode(unsettledNodes);
